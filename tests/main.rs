...
fn test_json_get_utf8() {
    ...
    let ColumnarValue::Scalar(sv) = json_get_str
        .invoke_with_args(ScalarFunctionArgs {
            args: args.to_vec(),
            arg_fields: vec![
                &Field::new("arg_1", DataType::LargeUtf8, false),
                &Field::new("arg_2", DataType::LargeUtf8, false),
                &Field::new("arg_3", DataType::LargeUtf8, false),
            ],
            number_rows: 1,
            return_field: &Field::new("ret_field", DataType::Utf8, false),
        })
        .unwrap()
    else {
